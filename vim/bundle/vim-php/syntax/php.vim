...
" Structure
syn keyword phpStructure  extends implements instanceof parent self this contained
...
syn match phpScopeResolutionSelector "::"  contained display
...
" Scope resolution
syn match phpScopeResolution "::\h\w*" contained contains=phpScopeResolutionSelector display

" Class name
syn match phpClassName "[A-Z]\w*" contained display
...
syn match phpMethodsVar "->\h\w*" contained contains=phpMemberSelector display containedin=phpStringDouble
...
if version >= 508 || !exists("did_php_syn_inits")
  ...
  HiLink   phpScopeResolutionSelector  Structure
