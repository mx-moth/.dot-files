...
syn match   rstExplicitMarkup display '^\s*\.\.\_s'
...
syn region rstDirectiveAutodoc contained matchgroup=rstDirective
      \ start=+auto\%(module\|class\)::\_s\+[a-zA-Z0-9_.]\+\n+
      \ skip=+^$+
      \ end=+^\z1\@!+
      \ contains=@rstAllTheThings
syn cluster rstDirectives add=rstDirectiveAutodoc
...
syn cluster rstAllTheThings contains=@rstCruft,rstExplicitMarkup,rstSections,rstTransition,rstDirectiveAutodoc
